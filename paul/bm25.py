...
for lang in ['ar','bn','en','es','fa','fi','fr','hi','id','ja','ko','ru','sw','te','th','zh']:
    # BM25 runfiles
    dsp='test-a'
    topic=f'topics/{lang}-{dsp}.tsv'
    #topic=f'miracl/miracl-v1.0-{lang}/topics/topics.miracl-v1.0-{lang}-{dsp}.tsv'
    rufiles_dir=f'data/bm25_{beta}_h1000'
